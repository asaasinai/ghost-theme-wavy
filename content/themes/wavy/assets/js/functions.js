...
(function($){
        ...
        if( document_width > 1024 ){
            if( theme_config.sticky_sidebar == 'on' ){
                setTimeout(function(){
                    ...
                    $('.epcl-share-container').theiaStickySidebar({
	...
	$(document).ready(function($){
        ...
        if( $('.text.main-content').find('h1, h2, h3, h4, h5').length > 0 ) {
            tocbot.init({
                // Where to render the table of contents.
                tocSelector: '.epcl-toc .toc-list',
                // Where to grab the headings to build the table of contents.
                contentSelector: '.text.main-content',
